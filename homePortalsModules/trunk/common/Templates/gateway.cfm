...
<!--- this is the name of the mapping or directory where HomePortalsModules is located --->
<cfparam name="HOMEPORTALS_MODULES_MAPPING" default="homePortalsModules">


<!--- references to homeportals resources --->
<cfset moduleControllerRemotePath = HOMEPORTALS_MODULES_MAPPING & ".components.moduleControllerRemote">

		...
		<cfif bIsContentOwner>
			<div id="#moduleID#_toolbar">
				...
				<cfif arguments.contentID neq "">
					<a href="javascript:#moduleID#.getPopupView('edit',{contentID:'#arguments.contentID#'});"><img src="/Home/Modules/editBox/images/edit-page-yellow.gif" border="0" align="absmiddle"></a>

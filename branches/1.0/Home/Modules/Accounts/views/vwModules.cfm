...
<table id="tblPageDesigner" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td rowspan="2">
			...
			<div class="cp_sectionBox" 
				style="margin-top:0px;width:150px;padding:0px;height:350px;margin-left:2px;margin-right:0px;">
	...
	<tr valign="top">
		<td colspan="2">
			...
			<div class="cp_sectionBox" 
				 style="margin:0px;padding:0px;height:142px;width:314px;margin-left:7px;margin-top:2px;">
				<form name="frm" action="##" method="post" style="margin:2px;padding:0px;">
					<table style="width:310px;">
						...
						<tr>
							...
							<td colspan="2">
								...
								<cfoutput>
									<input type="text" name="pageName" value="#tmpName#" style="width:200px;">
						...
						<tr>
							<td>&nbsp;</td>
							<td colspan="2">
								<input type="checkbox" name="isPrivate" value="1" style="width:auto;" 

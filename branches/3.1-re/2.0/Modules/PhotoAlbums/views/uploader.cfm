...
<cfoutput>
	<html>
		<head>
			<script src="#application.homePortalsRoot#/Modules/PhotoAlbums/scripts/multifile_compressed.js"></script>
			<style type="text/css">
				body {
					font-family:arial;
					font-size:11px;
		...
		<body>
			<form enctype="multipart/form-data" action="#application.homePortalsRoot#/Common/Templates/moduleGateway.cfm" method="post">
